...
For more information, visit http://github.com/jakevdp/mst_clustering
"""
NAME = "mst_clustering"
...
URL = 'http://github.com/jakevdp/mst_clustering'
DOWNLOAD_URL = 'http://github.com/jakevdp/mst_clustering'
LICENSE = 'new BSD'

VERSION = version('mst_clustering/__init__.py')
...
setup(name=NAME,
      ...
      license=LICENSE,
      packages=['mst_clustering',
                'mst_clustering.tests',
            ],
      classifiers=[
